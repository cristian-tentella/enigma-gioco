...
const start_without_first_scripted_interaction = true #Starta senza vederti tutta la parte iniziale
const start_with_minigame_1_finished = true #Starta con i nodi minigame 1 tolti
