...
func initialize_the_real_item_with_its_properties(item_resource: ItemResource):
...
func _ready():
	...
	var item_tres = load(tres_path) as ItemResource
	initialize_the_real_item_with_its_properties(item_tres)
