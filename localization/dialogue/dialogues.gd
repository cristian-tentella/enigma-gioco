...
const dialogues: Dictionary = {
	...
	#SECOND MINIGAME =======================================
	"memeory_first_dialogue":["memeory_first_dialogue_1", "memeory_first_dialogue_2", "memeory_first_dialogue_3", "memeory_first_dialogue_4", "memeory_first_dialogue_5", "memeory_first_dialogue_6", "memeory_first_dialogue_7"],
	...
	"pickup_guest_list": ["pickup_guest_list_1", "pickup_guest_list_2", "pickup_guest_list_3", "pickup_guest_list_4", "pickup_guest_list_5", "pickup_guest_list_6", "pickup_guest_list_7"],
	#=======================================
	...
	"bedroom_pc_interaction": ["bedroom_pc_interaction_1", "bedroom_pc_interaction_2"]
